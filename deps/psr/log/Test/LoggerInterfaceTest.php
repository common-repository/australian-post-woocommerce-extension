...
namespace WPRubyAustraliaPost\Deps\Psr\Log\Test;

use WPRubyAustraliaPost\Deps\Psr\Log\LoggerInterface;
use WPRubyAustraliaPost\Deps\Psr\Log\LogLevel;
use WPRubyAustraliaPost\Deps\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('WPRubyAustraliaPost\\Deps\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('WPRubyAustraliaPost\\Deps\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('WPRubyAustraliaPost\\Deps\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
